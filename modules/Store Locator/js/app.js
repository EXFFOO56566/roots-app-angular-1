...
(function(){
  ...
  app.controller('storesController', function($http, $scope, $compile, $sce){
    
    $scope.getAll = true;
    $scope.locationsType = 'map';
    $scope.centerMap = [40.7112, -74.213]; // Start Position in the Map
    $scope.API = 'http://dev.studio31.co/api/get_posts/?post_type=banks&posts_per_page=-1'; // Change this to your site
