...
(function(){
  ...
  var app = angular.module('app', ['onsen', 'angular-carousel', 'angular-images-loaded', 'ngAudio']);
  ...
  // Latest Video Controller
  // This controller gets all the posts from our WordPress site and inserts them into a variable called $scope.items
  app.controller('latestVideosController', [ '$http', '$scope', '$rootScope', function($http, $scope, $rootScope){
  ...
  app.controller('videostreamController', [ '$scope', '$rootScope', '$sce', function($scope, $rootScope, $sce){
    ...
    $scope.playVideo = function(){
      ...
      var videoUrl = $scope.item.custom_fields.url[0];
  ...
  // Read Controller
  // This controller gets all the posts from our WordPress site and inserts them into a variable called $scope.items
  app.controller('readController', [ '$http', '$scope', '$rootScope', function($http, $scope, $rootScope){
  ...
  app.controller('radioController', function($scope, $sce, ngAudio){
    ...
    $scope.radioOptions = {
      albumArt: 'images/church/cover.png',
      songName: ''
    }
